...
Received string: "http://localhost:5173/admin/events"
Timeout: 5000ms

Call log:
  - Expect "not toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:5173/admin/events"
...
- text: 報名中 截止：2025/7/2
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "古典音樂欣賞之夜" [level=2]
- text: 草稿 尚未開始報名 截止：2025/7/21
- button "發布"
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "員工家庭日" [level=2]
- text: 候補登記 截止：2025/8/21
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "美食嘉年華" [level=2]
- text: 報名中 截止：2025/8/11
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "員工路跑活動" [level=2]
- text: 報名中 截止：2025/9/2
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "日本東京員工旅遊" [level=2]
- text: 報名中 截止：2025/9/1
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "藝術展覽參觀" [level=2]
- text: 報名中 截止：2025/8/16
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "程式設計競賽" [level=2]
- text: 報名中 截止：2025/9/11
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "爵士樂之夜" [level=2]
- text: 報名截止 截止：2025/8/21
- button "報名詳情"
- button "核銷"
- button "刪除"
- heading "親子料理課" [level=2]
- text: 尚未開始報名 截止：2025/9/26
- button "報名詳情"
- button "核銷"
- button "刪除"
```
